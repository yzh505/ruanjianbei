...
import styles from '../../../scss/agentManage/myResources/flowChartRes.module.scss';
import img from '../../../image/1.png'
import {getPictureSum,getPrivateResource} from '../../../api/courseware'; 
...
const TeacherPlanRes = () => {
  ...
  const fetchData=async (page)=>{
   ...
   const fetchSumData= async ()=>{
          try{
           const res =await getPictureSum(userInfo.uid);
          ...
          <>
            <div className={styles.videoGrid}>
              {pptResources.map((ppt) => (
                  <div className={styles.videoCard} onClick={()=>handleNavigation(ppt.pictureId)}>
                    <div className={styles.videoThumbnail}>
                       <div className={styles.videoPreview}>
                        <img src={ppt.pictureUrl} alt={ppt.textName} />
                      ...
                      <h3>标题：{ppt.pictureName}</h3>
                      <p>介绍：{ppt.pictureIntroduction}</p>
                    </div>
                  </div>
              ))}
            </div>
