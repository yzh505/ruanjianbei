...
import styles from '../../../scss/agentManage/myResources/Paper.module.scss';
import img from '../../../image/1.png'
import {getPrivateResource,saveTextResource} from '../../../api/courseware'; 
import { useNavigate } from 'react-router-dom';
import { getExamsSum } from '../../../api/exercise';
const { Search } = Input;
const { Option } = Select;
...
const handleNavigation = () => {
  ...
  const fetchData=async (page)=>{
   ...
   const fetchSumData= async ()=>{
     try{
       const res =await getExamsSum(userInfo.uid);
          ...
          <>
            <div className={styles.videoGrid}>
              {pptResources.map((item) => (
                  <div className={styles.videoCard} style={{padding: 14, display: 'flex', flexDirection: 'column', justifyContent: 'space-between',width:'20%'}}>
